...
describe("Auth Verify Error Page Component", () => {
  ...
  it("displays the error message", () => {
    ...
    expect(screen.getByText("Encountered an error when trying to retrieve email. Please try again.")).toBeDefined();
  });
  ...
  it("contains an h3 heading", () => {
    ...
    expect(heading?.textContent).toBe("Encountered an error when trying to retrieve email. Please try again.");
  });
