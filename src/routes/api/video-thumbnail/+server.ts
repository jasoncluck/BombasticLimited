...
export const GET: RequestHandler = async ({ url, request }) => {
  ...
  try {
    ...
    console.warn('[DEPRECATED] video-thumbnail API called - use background processing system instead');
...
export const POST: RequestHandler = async ({ request }) => {
  try {
    ...
    // Background processing system handles optimization instead
    console.warn('[DEPRECATED] video-thumbnail batch API called - use background processing system instead');
