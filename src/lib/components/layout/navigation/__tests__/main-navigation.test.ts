...
vi.mock('$lib/components/side-drawer.svelte', () => ({
  default: () => ({ render: () => '<div data-testid="side-drawer">Side Drawer</div>' }),
}));

vi.mock('./search-input.svelte', () => ({
  default: () => ({ render: () => '<div data-testid="search-input">Search Input</div>' }),
}));

vi.mock('./user-menu.svelte', () => ({
  default: () => ({ render: () => '<div data-testid="user-menu">User Menu</div>' }),
}));

vi.mock('$lib/assets/brand-logo.svelte', () => ({
  default: () => ({ render: () => '<div data-testid="brand-logo">Brand Logo</div>' }),
}));
