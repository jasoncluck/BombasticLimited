...
<style>
  /* Hide first column (play column) by default - targets the actual <td> */
  :global(.content-table tbody tr td:first-child),
  :global(.content-table thead tr th:first-child) {
    display: none;
  }

  /* Show first column on hover-capable devices */
  @media (hover: hover) {
    :global(.content-table tbody tr td:first-child),
    :global(.content-table thead tr th:first-child) {
      display: table-cell;
  ...
  /* Actions column: Hide hover actions by default, show touch actions */
  :global(.content-table .actions-column .hover-actions) {
    display: none;
  }

  :global(.content-table .actions-column .touch-actions) {
    display: block;
  }

  /* On hover-capable devices, show hover actions and hide touch actions */
  @media (hover: hover) {
    :global(.content-table .actions-column .hover-actions) {
      display: block;
    }
