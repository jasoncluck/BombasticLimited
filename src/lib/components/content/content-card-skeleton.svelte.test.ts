...
describe("Content Card Skeleton Component", () => {
  ...
  it("renders dropdown button skeleton", () => {
    ...
    const dropdownSkeleton = container.querySelector(".absolute.top-0\\.5.right-0\\.5 .h-6.w-6");
  ...
  it("renders playlist info skeleton section", () => {
    ...
    const playlistSection = container.querySelector(".flex.items-center.gap-2.mt-1.mb-3.px-2");
