...
<Dialog.Root bind:open>
  <Dialog.Content class="min-w-[375px] sm:max-w-[800px] w-[90%]">
      ...
      <div class="flex flex-col sm:flex-row justify-center gap-4 mb-4">
          ...
          {:else}
            ...
            <Popover.Root>
              ...
              <Popover.Content align="start"
                ><p class="text-sm">
                  Selecting and editing a playlist image can only be done after
                  selecting a video thumbnail to use as the image. This can be
                  set by right-clicking on a video in a playlist.
                </p>
              </Popover.Content>
            </Popover.Root>
          {/if}
        ...
        <div class="flex flex-col relative grow">
          <Form.Field form={playlistForm} name="name">
            <div
              class="md:grid md:grid-cols-4 items-center flex flex-wrap gap-2 md:gap-4 mb-4"
            >
              <Form.Control>
          ...
          >
            <div
              class="md:grid md:grid-cols-4 items-center md:items-start flex flex-wrap gap-2 md:gap-4 md:h-full"
            >
              <Form.Control>
                {#snippet children({ props })}
                  ...
                  <Textarea
                    {...props}
                    class="col-span-3 max-h-64 md:min-h-full"
