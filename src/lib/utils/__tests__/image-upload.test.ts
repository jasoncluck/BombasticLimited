...
describe('image-upload', () => {
  ...
  describe('dataURLtoFile', () => {
    ...
    it('should work with different file extensions', () => {
      const testCases = [
        { dataURL: 'data:image/webp;base64,dGVzdA==', filename: 'test.webp', expectedType: 'image/webp' },
        { dataURL: 'data:image/gif;base64,dGVzdA==', filename: 'test.gif', expectedType: 'image/gif' },
        { dataURL: 'data:image/svg+xml;base64,dGVzdA==', filename: 'test.svg', expectedType: 'image/svg+xml' }
      ];
  ...
  describe('deletePlaylistImage', () => {
    ...
    it('should handle storage deletion errors', async () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Storage deletion error:', storageError);
  ...
  describe('integration scenarios', () => {
    it('should handle complete image upload workflow', () => {
      ...
      const mockBase64Data = 'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==';
    ...
    it('should maintain file integrity across conversions', () => {
      ...
      const dataURL = 'data:image/jpeg;base64,YmluYXJ5LWZpbGUtY29udGVudC10ZXN0LTEyMw==';
