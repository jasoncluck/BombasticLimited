...
describe('video-thumbnails (updated for Vercel)', () => {
  describe('getVideoThumbnailUrl', () => {
    ...
    it('should accept custom config', () => {
      const video = createMockVideo('1', 'https://i.ytimg.com/vi/1/hqdefault.jpg', null);
      const config = { width: 320, height: 180, quality: 75, format: 'webp' as const };
  ...
  describe('getVideoThumbnailDataUrl', () => {
    ...
    it('should prefer maxres URL when available', () => {
      ...
      const expectedUrl = `/api/video-thumbnail?type=json&url=${encodeURIComponent('https://i.ytimg.com/vi/1/maxresdefault.jpg')}`;
      expect(result).toBe(expectedUrl);
    });
  ...
  describe('getDirectThumbnailUrl', () => {
    it('should return best available direct URL', () => {
      const video = createMockVideo(
        '1',
        'https://i.ytimg.com/vi/1/hqdefault.jpg',
        'https://i.ytimg.com/vi/1/maxresdefault.jpg'
  ...
  describe('extractOriginalUrl', () => {
    it('should extract URL from Vercel-optimized format', () => {
      const optimizedUrl = '/_vercel/image?url=https%3A//i.ytimg.com/vi/1/hqdefault.jpg&w=480&h=360&q=90';
