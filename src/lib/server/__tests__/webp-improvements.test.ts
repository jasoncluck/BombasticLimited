...
describe('WebP Processing Improvements', () => {
  describe('Enhanced Quality Calculation', () => {
    it('should provide better base quality for WebP', () => {
      ...
      console.log(
        `🎯 WebP quality: ${webpQuality}, JPEG quality: ${jpegQuality}`
      );
    });
  ...
  describe('Compression Efficiency', () => {
    it('should demonstrate WebP improvements maintain excellent compression', () => {
      ...
      const smallImageQuality = calculateOptimalQuality(
        { width: 180, height: 180 },
        'webp'
      );
      const mediumImageQuality = calculateOptimalQuality(
        { width: 720, height: 480 },
        'webp'
      );
      const largeImageQuality = calculateOptimalQuality(
      ...
      console.log(
        `📊 Quality progression - Small: ${smallImageQuality}, Medium: ${mediumImageQuality}, Large: ${largeImageQuality}`
      );
    });
  });
});
