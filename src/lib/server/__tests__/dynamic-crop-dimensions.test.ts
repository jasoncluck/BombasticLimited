...
import { calculateDynamicCropDimensions, validateAndAdjustCropDimensions } from '$lib/utils/dynamic-crop-dimensions';
...
describe('Dynamic Crop Dimensions', () => {
  describe('calculateDynamicCropDimensions', () => {
    ...
    it('should use custom properties when provided', () => {
      ...
      const result = calculateDynamicCropDimensions(800, 600, true, customProps);
