...
export async function createPlaylist({
  ...
  const { data: playlist, error } = await neon
    .rpc('insert_playlist', {
      p_created_by: userId,
      p_name: name,
      p_type: 'Private',
...
export async function updatePlaylistPosition({
  ...
  const { error } = await neon.rpc('update_playlist_position', {
...
export async function deletePlaylist({
  ...
  const { error } = await neon.rpc('delete_playlist', {
    p_playlist_id: playlistId,
    p_user_id: userId,
  });
...
export async function addVideosToPlaylist({
  ...
  const { error } = await neon.rpc('insert_playlist_videos', {
    p_playlist_id: playlistId,
...
export async function updatePlaylistVideoPosition({
  ...
  const { error } = await neon.rpc('update_playlist_videos_positions', {
    p_playlist_id: playlistId,
    p_video_ids: videoIds,
    p_new_position: position,
    p_user_id: userId,
...
export async function updatePlaylistInfo({
  ...
  const { data: updatedPlaylist, error } = await neon
    .from('playlists')
    .update({
      name: name.trim(),
...
export async function updatePlaylistThumbnail({
  ...
  const { error } = await neon.rpc('update_playlist_thumbnail', {
    p_playlist_id: playlistId,
