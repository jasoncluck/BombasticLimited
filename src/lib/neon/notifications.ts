...
export async function getNotifications({
  ...
  const { data, error } = await neon.rpc('get_user_notifications', {
...
export async function getUnreadCount({
  ...
  const { data, error } = await neon.rpc('get_unread_notification_count');
...
export async function getNotificationCounts({
  ...
  const { data: notifications, error } = await neon.rpc(
...
export async function markAsRead({
  ...
  const { error } = await neon.rpc('mark_notifications_as_read', {
...
export async function createNotification({
  ...
  const { data, error } = await neon.rpc('create_notification', {
...
export async function deleteNotifications({
  ...
  const { data, error } = await neon.rpc('remove_user_notification', {
    notification_ids: notificationIds,
  });
...
export async function createNotificationForAllUsers({
  ...
  const { data, error } = await neon.rpc('create_notification_for_all_users', {
    notification_type: params.type,
    notification_title: params.title,
    notification_message: params.message,
    notification_metadata: params.metadata || {},
