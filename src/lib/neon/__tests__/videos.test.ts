...
describe('videos module', () => {
  ...
  describe('getVideos', () => {
    it('should fetch videos successfully without search', async () => {
      ...
      (mockNeon.rpc as any).mockReturnValue(mockQuery);
  ...
  describe('getVideo', () => {
    it('should fetch single video successfully', async () => {
      ...
      expect(mockNeon.rpc).toHaveBeenCalledWith('get_videos_with_timestamps', {
        p_preferred_image_format: 'avif',
      });
      expect(result.error).toBeNull();
  ...
  describe('incrementVideoView', () => {
    it('should call RPC to increment video views', () => {
      (mockNeon.rpc as any).mockImplementation(() => {});
      ...
      expect(mockNeon.rpc).toHaveBeenCalledWith('increment_video_views', {
