...
describe('notifications module', () => {
  ...
  describe('getNotifications', () => {
    ...
    it('should fetch notifications successfully', async () => {
      ...
      expect(mockNeon.rpc).toHaveBeenCalledWith('get_user_notifications', {
        limit_count: 20,
        offset_count: 0,
  ...
  describe('getUnreadCount', () => {
    it('should fetch unread count successfully', async () => {
      ...
      const result = await getUnreadCount({ neon: mockNeon });
  ...
  describe('getNotificationCounts', () => {
    it('should fetch notification counts successfully', async () => {
      ...
      const result = await getNotificationCounts({ neon: mockNeon });
  ...
  describe('markAsRead', () => {
    it('should mark notifications as read successfully', async () => {
      ...
      expect(mockNeon.rpc).toHaveBeenCalledWith('mark_notifications_as_read', {
  ...
  describe('createNotification', () => {
    it('should create notification successfully', async () => {
      ...
      expect(mockNeon.rpc).toHaveBeenCalledWith('create_notification', {
  ...
  describe('deleteNotifications', () => {
    it('should delete notifications successfully', async () => {
      ...
      expect(mockNeon.rpc).toHaveBeenCalledWith('remove_user_notification', {
        notification_ids: [1, 2, 3],
      });
