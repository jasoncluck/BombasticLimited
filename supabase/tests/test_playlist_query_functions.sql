...
SELECT * FROM insert_playlist('11111111-1111-1111-1111-111111111111'::uuid, 'Playlist 1', NULL, 'Public'::playlist_type);
SELECT * FROM insert_playlist('11111111-1111-1111-1111-111111111111'::uuid, 'Playlist 2', NULL, 'Private'::playlist_type);
SELECT * FROM insert_playlist('11111111-1111-1111-1111-111111111111'::uuid, 'Playlist 3', NULL, 'Public'::playlist_type);
