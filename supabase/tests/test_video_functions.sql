...
VALUES
  ...
  (
    ...
    'jeffgerstmann',
    'Search Test Video',
    'This video is for search testing',
    'http://example.com/thumb3.jpg',
    '45:20',
    FALSE
  );
...
INSERT INTO
  public.timestamps (user_id, video_id, video_start_seconds)
VALUES
  (
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
    'testvid1',
  ...
  ok (
    (
      SELECT
        COUNT(*)
      FROM
        search_videos ('This video is for search testing', 0)
    ) >= 1,
