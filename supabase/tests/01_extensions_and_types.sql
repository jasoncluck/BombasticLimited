...
SELECT ok(
    EXISTS(SELECT 1 FROM pg_type WHERE typname = 'source'),
...
SELECT ok(
    EXISTS(SELECT 1 FROM pg_type WHERE typname = 'playlist_type'),
...
SELECT ok(
    EXISTS(SELECT 1 FROM pg_type WHERE typname = 'content_description'),
