...
SELECT has_function('public', 'is_unique_username', ARRAY['text'], 'Function is_unique_username should exist');

SELECT has_function('public', 'generate_unique_username', ARRAY['text', 'uuid'], 'Function generate_unique_username should exist');
...
SELECT ok(
    length(public.generate_unique_username('verylongusernamethatexceedslimits')) <= 50,
