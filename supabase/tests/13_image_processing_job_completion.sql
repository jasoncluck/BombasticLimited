...
VALUES
  (
    'test_video_completion',
    'giantbomb',
    'Test Video for Job Completion',
  ...
  ok (
    EXISTS (
      SELECT
        1
      FROM
        public.detect_orphaned_image_processing_jobs ()
      WHERE
        job_id = '44444444-4444-4444-4444-444444444444'::uuid
    ),
