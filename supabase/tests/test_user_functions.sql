...
INSERT INTO auth.users (id, email) VALUES 
    ('77777777-7777-7777-7777-777777777777', 'existinguser@example.com'),
    ('88888888-8888-8888-8888-888888888888', 'anotheruser@example.com'),
    ('99999999-9999-9999-9999-999999999999', 'newuser@example.com')
ON CONFLICT (id) DO NOTHING;

INSERT INTO public.profiles (id, username) VALUES 
    ('77777777-7777-7777-7777-777777777777', 'existinguser'),
    ('88888888-8888-8888-8888-888888888888', 'anotheruser')
ON CONFLICT (id) DO NOTHING;
