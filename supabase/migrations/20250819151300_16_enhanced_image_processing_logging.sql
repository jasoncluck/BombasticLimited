...
VALUES (
    'migration_started',
    jsonb_build_object(
        'migration_name', '16_enhanced_image_processing_logging.sql',
        'start_time', now(),
        'author', 'jasoncluck',
        'description', 'Enhanced comprehensive logging for image processing pipeline debugging',
        'purpose', 'Debug multiple video thumbnail generation issue'
    ),
    now()
);
...
VALUES (
    ...
    jsonb_build_object(
        ...
        'completion_time', now(),
        'author', 'jasoncluck',
        'description', 'Enhanced comprehensive logging for image processing pipeline debugging - enables tracing complete job lifecycle to identify duplicate processing causes',
