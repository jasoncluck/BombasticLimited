-- Migration: Add optimized image paths to video query functions
-- This migration updates RPC functions to include optimized image storage paths
-- Required for proper image fallback functionality

-- Update get_videos_with_timestamps function to include optimized image paths
...
-- Update search_videos function to include optimized image paths
...
-- Update get_in_progress_videos_with_timestamps function to include optimized image paths
