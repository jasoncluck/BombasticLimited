...
CREATE TABLE IF NOT EXISTS "public"."video_history" (
  "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."video_history_id_seq" START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
  ),
...
CREATE POLICY "Users can access their own video history" ON "public"."video_history"
...
CREATE OR REPLACE FUNCTION "public"."update_video_history_updated_at"()
RETURNS TRIGGER
LANGUAGE plpgsql
SET search_path = ''
AS $$
...
CREATE OR REPLACE FUNCTION "public"."auto_record_video_history"()
RETURNS TRIGGER
LANGUAGE plpgsql
SET search_path = ''
AS $$
...
CREATE TRIGGER "trigger_auto_record_video_history"
  AFTER INSERT OR UPDATE ON "public"."timestamps"
  FOR EACH ROW
